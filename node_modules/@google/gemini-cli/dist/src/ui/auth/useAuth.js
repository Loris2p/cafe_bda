...
import { AuthType, loadApiKey, debugLogger, isAccountSuspendedError, } from '@google/gemini-cli-core';
...
export const useAuthCommand = (settings, config, initialAuthError = null, initialAccountSuspensionInfo = null) => {
    ...
    const [accountSuspensionInfo, setAccountSuspensionInfo] = useState(initialAccountSuspensionInfo);
