...
export function useAtCompletion(props) {
    ...
    const fileSearchMap = useRef(new Map());
    ...
    useEffect(() => {
        const initialize = async () => {
            ...
            try {
                ...
                for (const dir of directories) {
                    if (fileSearchMap.current.has(dir))
                        continue;
                    ...
                    initPromises.push(searcher.initialize().then(() => {
        ...
        const search = async () => {
            ...
            try {
                ...
                const allSearchPromises = [...fileSearchMap.current.entries()].map(async ([dir, searcher]) => {
                ...
                const resourceSuggestions = (await searchResourceCandidates(currentPattern ?? '', resourceCandidates)).map((suggestion) => ({
                    ...suggestion,
