...
import { UserTierId, getCodeAssistServer, debugLogger, } from '@google/gemini-cli-core';
...
async function getRemoteDataCollectionOptIn(server) {
    try {
        ...
        if (resp.freeTierDataCollectionOptin === undefined) {
            debugLogger.warn('Warning: Code Assist API did not return freeTierDataCollectionOptin. Defaulting to true.');
        }
...
async function setRemoteDataCollectionOptIn(server, optIn) {
    ...
    if (resp.freeTierDataCollectionOptin === undefined) {
        debugLogger.warn(`Warning: Code Assist API did not return freeTierDataCollectionOptin. Defaulting to ${optIn}.`);
    }
