...
describe('<StatsDisplay />', () => {
    ...
    describe('Title Rendering', () => {
        ...
        it('renders the custom title when a title prop is provided', async () => {
            ...
            const { lastFrame, waitUntilReady } = renderWithProviders(_jsx(StatsDisplay, { duration: "1s", title: "Agent powering down. Goodbye!" }), { width: 100 });
            await waitUntilReady();
            const output = lastFrame();
    ...
    describe('Quota Display', () => {
        it('renders quota information when quotas are provided', async () => {
            ...
            const { lastFrame, waitUntilReady } = renderWithProviders(_jsx(StatsDisplay, { duration: "1s", quotas: quotas }), { width: 100 });
            await waitUntilReady();
            const output = lastFrame();
        ...
        it('renders pooled quota information for auto mode', async () => {
            ...
            const { lastFrame, waitUntilReady } = renderWithProviders(_jsx(StatsDisplay, { duration: "1s", quotas: quotas, currentModel: "auto", quotaStats: {
                    remaining: 710,
                    limit: 1100,
                } }), { width: 100 });
            await waitUntilReady();
    ...
    describe('User Identity Display', () => {
        it('renders User row with Auth Method and Tier', async () => {
            ...
            const { lastFrame, waitUntilReady } = renderWithProviders(_jsx(StatsDisplay, { duration: "1s", selectedAuthType: "oauth", userEmail: "test@example.com", tier: "Pro" }), { width: 100 });
            await waitUntilReady();
            const output = lastFrame();
        ...
        it('renders User row with API Key and no Tier', async () => {
            ...
            const { lastFrame, waitUntilReady } = renderWithProviders(_jsx(StatsDisplay, { duration: "1s", selectedAuthType: "Google API Key" }), { width: 100 });
            await waitUntilReady();
            const output = lastFrame();
            expect(output).toContain('Auth Method:');
