...
describe('PermissionsModifyTrustDialog', () => {
    ...
    it('should render the main dialog with current trust level', async () => {
        const { lastFrame, waitUntilReady, unmount } = renderWithProviders(_jsx(PermissionsModifyTrustDialog, { onExit: vi.fn(), addItem: vi.fn() }));
    ...
    it('should call onExit when escape is pressed', async () => {
        const onExit = vi.fn();
        const { stdin, lastFrame, waitUntilReady, unmount } = renderWithProviders(_jsx(PermissionsModifyTrustDialog, { onExit: onExit, addItem: vi.fn() }));
        await waitUntilReady();
