...
describe('InputPrompt', () => {
    ...
    describe('Highlighting and Cursor Display', () => {
        describe('single-line scenarios', () => {
            it.each([
            ...
            ])('should display cursor correctly $name', async ({ name, text, visualCursor, expected }) => {
                mockBuffer.text = text;
                ...
                await waitFor(() => {
                    ...
                    if (name !== 'at the end of a line with unicode characters' &&
                        name !== 'on a highlighted token') {
        ...
        describe('multi-line scenarios', () => {
            ...
            ])('should display cursor correctly $name in a multiline block', async ({ name, text, visualCursor, expected, visualToLogicalMap }) => {
                mockBuffer.text = text;
                mockBuffer.lines = text.split('\n');
