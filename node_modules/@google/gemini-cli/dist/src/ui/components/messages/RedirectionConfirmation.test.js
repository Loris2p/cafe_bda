...
describe('ToolConfirmationMessage Redirection', () => {
    ...
    it('should display redirection warning and tip for redirected commands', async () => {
        ...
        const { lastFrame, waitUntilReady, unmount } = renderWithProviders(_jsx(ToolConfirmationMessage, { callId: "test-call-id", confirmationDetails: confirmationDetails, config: mockConfig, getPreferredEditor: vi.fn(), availableTerminalHeight: 30, terminalWidth: 100 }));
