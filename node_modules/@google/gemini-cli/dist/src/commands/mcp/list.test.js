...
describe('mcp list command', () => {
    ...
    it('should filter servers based on admin allowlist passed in settings', async () => {
        ...
        expect(debugLogger.log).toHaveBeenCalledWith(expect.stringContaining('allowed-server'));
        expect(debugLogger.log).not.toHaveBeenCalledWith(expect.stringContaining('forbidden-server'));
        expect(mockedCreateTransport).toHaveBeenCalledWith('allowed-server', expect.objectContaining({ url: 'http://allowed' }), // Should use admin config
