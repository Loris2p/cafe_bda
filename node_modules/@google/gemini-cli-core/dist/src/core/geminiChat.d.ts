...
export declare class GeminiChat {
    ...
    constructor(config: Config, systemInstruction?: string, tools?: Tool[], history?: Content[], resumedSessionData?: ResumedSessionData, onModelChanged?: ((modelId: string) => Promise<Tool[]>) | undefined, kind?: 'main' | 'subagent');
