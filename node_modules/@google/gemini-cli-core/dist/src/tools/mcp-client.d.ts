...
export declare class McpClient implements McpProgressReporter {
    ...
    constructor(serverName: string, serverConfig: MCPServerConfig, toolRegistry: ToolRegistry, promptRegistry: PromptRegistry, resourceRegistry: ResourceRegistry, workspaceContext: WorkspaceContext, cliConfig: McpContext, debugMode: boolean, clientVersion: string, onToolsUpdated?: ((signal?: AbortSignal) => Promise<void>) | undefined);
    /**
     ...
     */
    discover(cliConfig: McpContext): Promise<void>;
    /**
 ...
 */
export declare function connectAndDiscover(clientVersion: string, mcpServerName: string, mcpServerConfig: MCPServerConfig, toolRegistry: ToolRegistry, promptRegistry: PromptRegistry, debugMode: boolean, workspaceContext: WorkspaceContext, cliConfig: McpContext): Promise<void>;
/**
 ...
 */
export declare function discoverTools(mcpServerName: string, mcpServerConfig: MCPServerConfig, mcpClient: Client, cliConfig: McpContext, messageBus: MessageBus, options?: {
    timeout?: number;
    signal?: AbortSignal;
 ...
 * @param mcpClient The active MCP client instance.
 */
export declare function discoverPrompts(mcpServerName: string, mcpClient: Client, cliConfig: McpContext, options?: {
    signal?: AbortSignal;
}): Promise<DiscoveredMCPPrompt[]>;
export declare function discoverResources(mcpServerName: string, mcpClient: Client, cliConfig: McpContext): Promise<Resource[]>;
/**
 ...
 */
export declare function invokeMcpPrompt(mcpServerName: string, mcpClient: Client, promptName: string, promptParams: Record<string, unknown>, cliConfig: McpContext): Promise<GetPromptResult>;
/**
 * @visiblefortesting
 ...
 */
export declare function connectToMcpServer(clientVersion: string, mcpServerName: string, mcpServerConfig: MCPServerConfig, debugMode: boolean, workspaceContext: WorkspaceContext, cliConfig: McpContext): Promise<Client>;
/** Visible for Testing */
export declare function createTransport(mcpServerName: string, mcpServerConfig: MCPServerConfig, debugMode: boolean, cliConfig: McpContext): Promise<Transport>;
interface NamedTool {
    name?: string;
}
/** Visible for testing */
