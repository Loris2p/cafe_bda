...
describe('ToolRegistry', () => {
    ...
    describe('plan mode', () => {
        ...
        it('should include read-only MCP tools when allowed by policy in plan mode', () => {
            const readOnlyMcp = createMCPTool('test-server', 'read-only-tool', 'A read-only MCP tool');
        ...
        it('should exclude non-read-only MCP tools when denied by policy in plan mode', () => {
            const writeMcp = createMCPTool('test-server', 'write-mcp-tool', 'A write MCP tool');
