...
import { GeminiCliOperation, GEN_AI_TOOL_CALL_ID, GEN_AI_TOOL_DESCRIPTION, GEN_AI_TOOL_NAME, } from '../telemetry/constants.js';
    ...
    async execute(context) {
        ...
        return runInDevTraceSpan({
            ...
            try {
                ...
                if (signal.aborted) {
                    completedToolCall = this.createCancelledResult(call, 'User cancelled tool execution.');
                }
                ...
                if (signal.aborted) {
                    ...
                    completedToolCall = this.createErrorResult(call, error, ToolErrorType.UNHANDLED_EXCEPTION);
                }
            }
