...
Application Flutter pour la gestion de la boutique du BDA (Ventes, Rechargements, Membres).
...
### Mode Administrateur
Le mode administrateur permet d'accéder aux statistiques, à la gestion des produits et à l'inscription de nouveaux membres.
...
3. Un lien `mailto:` pré-rempli est proposé pour envoyer les identifiants au nouveau membre.
