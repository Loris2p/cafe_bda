...
import { cleanupCheckpoints, registerCleanup, registerSyncCleanup, runExitCleanup, registerTelemetryConfig, setupSignalHandlers, setupTtyCheck, } from './utils/cleanup.js';
...
export async function startInteractiveUI(config, settings, startupWarnings, workspaceRoot = process.cwd(), resumedSessionData, initializationResult) {
    ...
    // screen readers.
    const useAlternateBuffer = shouldEnterAlternateScreen(isAlternateBufferEnabled(config), config.getScreenReader());
