...
describe('skill uninstall command', () => {
    ...
    it('should call uninstallSkill with correct arguments for user scope', async () => {
        ...
        expect(emitConsoleLog).toHaveBeenCalledWith('log', expect.stringContaining('Successfully uninstalled skill: test-skill'));
        expect(emitConsoleLog).toHaveBeenCalledWith('log', expect.stringContaining('location: /mock/user/skills/test-skill'));
    });
    ...
    it('should log an error if skill is not found', async () => {
        ...
        expect(emitConsoleLog).toHaveBeenCalledWith('error', 'Skill "test-skill" is not installed in the user scope.');
    });
