...
vi.mock('@google/gemini-cli-core', async (importOriginal) => {
    ...
    return mockCoreDebugLogger(await importOriginal(), { stripAnsi: true });
});
...
describe('extensions link command', () => {
    ...
    describe('handleLink', () => {
        it('should link an extension from a local path', async () => {
            ...
            expect(coreEvents.emitConsoleLog).toHaveBeenCalledWith('log', 'Extension "my-linked-extension" linked successfully and enabled.');
            mockCwd.mockRestore();
        });
        it('should log an error message and exit with code 1 when linking fails', async () => {
            ...
            await handleLink({ path: '/local/path/to/extension' });
            expect(coreEvents.emitConsoleLog).toHaveBeenCalledWith('error', 'Link failed message');
