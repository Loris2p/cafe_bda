...
describe('SettingsSchema', () => {
    describe('getSettingsSchema', () => {
        ...
        it('should have gemmaModelRouter setting in schema', () => {
            const gemmaModelRouter = getSettingsSchema().experimental.properties.gemmaModelRouter;
            ...
            expect(gemmaModelRouter.description).toBe('Enable Gemma model router (experimental).');
            ...
            expect(enabled.description).toBe('Enable the Gemma Model Router. Requires a local endpoint serving Gemma via the Gemini API using LiteRT-LM shim.');
            ...
            expect(model.description).toBe('The model to use for the classifier. Only tested on `gemma3-1b-gpu-custom`.');
        });
    });
