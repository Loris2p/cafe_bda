...
import { DEFAULT_BACKGROUND_OPACITY, DEFAULT_INPUT_BACKGROUND_OPACITY, DEFAULT_BORDER_OPACITY, } from '../constants.js';
export const lightTheme = {
    ...
    InputBackground: interpolateColor('#FAFAFA', '#97a0b0', DEFAULT_INPUT_BACKGROUND_OPACITY),
    MessageBackground: interpolateColor('#FAFAFA', '#97a0b0', DEFAULT_BACKGROUND_OPACITY),
...
export const darkTheme = {
    ...
    InputBackground: interpolateColor('#1E1E2E', '#6C7086', DEFAULT_INPUT_BACKGROUND_OPACITY),
    MessageBackground: interpolateColor('#1E1E2E', '#6C7086', DEFAULT_BACKGROUND_OPACITY),
    GradientColors: ['#4796E4', '#847ACE', '#C3677F'],
};
        ...
        this.semanticColors = semanticColors ?? {
            ...
            background: {
                ...
                message: this.colors.MessageBackground ??
                    interpolateColor(this.colors.Background, this.colors.Gray, DEFAULT_BACKGROUND_OPACITY),
...
export function createCustomTheme(customTheme) {
    const colors = {
        ...
        DarkGray: customTheme.DarkGray ??
            interpolateColor(customTheme.background?.primary ?? customTheme.Background ?? '', customTheme.text?.secondary ?? customTheme.Gray ?? '', DEFAULT_BORDER_OPACITY),
        InputBackground: interpolateColor(customTheme.background?.primary ?? customTheme.Background ?? '', customTheme.text?.secondary ?? customTheme.Gray ?? '', DEFAULT_INPUT_BACKGROUND_OPACITY),
        MessageBackground: interpolateColor(customTheme.background?.primary ?? customTheme.Background ?? '', customTheme.text?.secondary ?? customTheme.Gray ?? '', DEFAULT_BACKGROUND_OPACITY),
