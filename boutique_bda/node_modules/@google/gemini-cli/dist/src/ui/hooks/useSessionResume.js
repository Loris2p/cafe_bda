...
import { coreEvents, convertSessionToClientHistory, } from '@google/gemini-cli-core';
...
export function useSessionResume({ config, historyManager, refreshStatic, isGeminiClientInitialized, setQuittingMessages, resumedSessionData, isAuthenticating, }) {
    ...
    const loadHistoryForResume = useCallback(async (uiHistory, clientHistory, resumedData) => {
        // Wait for the client.
    ...
    useEffect(() => {
        if (resumedSessionData &&
            ...
            void loadHistoryForResume(historyData.uiHistory, convertSessionToClientHistory(resumedSessionData.conversation.messages), resumedSessionData);
        }
    }, [
        resumedSessionData,
        isAuthenticating,
