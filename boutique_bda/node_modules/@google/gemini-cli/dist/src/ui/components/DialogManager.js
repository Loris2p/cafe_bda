...
export const DialogManager = ({ addItem, terminalWidth, }) => {
    ...
    if (uiState.quota.overageMenuRequest) {
        return (_jsx(OverageMenuDialog, { failedModel: uiState.quota.overageMenuRequest.failedModel, fallbackModel: uiState.quota.overageMenuRequest.fallbackModel, resetTime: uiState.quota.overageMenuRequest.resetTime, creditBalance: uiState.quota.overageMenuRequest.creditBalance, onChoice: uiActions.handleOverageMenuChoice }));
    }
    if (uiState.quota.emptyWalletRequest) {
        return (_jsx(EmptyWalletDialog, { failedModel: uiState.quota.emptyWalletRequest.failedModel, fallbackModel: uiState.quota.emptyWalletRequest.fallbackModel, resetTime: uiState.quota.emptyWalletRequest.resetTime, onGetCredits: uiState.quota.emptyWalletRequest.onGetCredits, onChoice: uiActions.handleEmptyWalletChoice }));
    }
