...
describe('ToolMessage Sticky Header Regression', () => {
    ...
    it('verifies that multiple ToolMessages in a ToolGroupMessage in a ScrollableList have sticky headers', async () => {
        ...
        const TestComponent = () => {
            ...
            return (_jsx(ScrollableList, { ref: internalRef, data: ['item1'], renderItem: () => (_jsx(ToolGroupMessage, { item: { id: 1, type: 'tool_group', tools: toolCalls }, toolCalls: toolCalls, terminalWidth: terminalWidth - 2 })), estimatedItemHeight: () => 30, keyExtractor: (item) => item, hasFocus: true }));
        };
        const { lastFrame, waitUntilReady, unmount } = renderWithProviders(_jsx(Box, { height: terminalHeight, children: _jsx(TestComponent, {}) }), {
            width: terminalWidth,
