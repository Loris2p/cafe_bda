...
describe('ToolConfirmationMessage', () => {
    ...
    it('should not display urls if prompt and url are the same', async () => {
        ...
        const { lastFrame, waitUntilReady, unmount } = renderWithProviders(_jsx(ToolConfirmationMessage, { callId: "test-call-id", confirmationDetails: confirmationDetails, config: mockConfig, getPreferredEditor: vi.fn(), availableTerminalHeight: 30, terminalWidth: 80 }));
    ...
    describe('with folder trust', () => {
        ...
        describe.each([
            ...
            it('should show "allow always" when folder is trusted', async () => {
                ...
                const { lastFrame, waitUntilReady, unmount } = renderWithProviders(_jsx(ToolConfirmationMessage, { callId: "test-call-id", confirmationDetails: details, config: mockConfig, getPreferredEditor: vi.fn(), availableTerminalHeight: 30, terminalWidth: 80 }));
                await waitUntilReady();
                expect(lastFrame()).toMatchSnapshot();
                unmount();
            });
    ...
    describe('enablePermanentToolApproval setting', () => {
        ...
        it('should NOT show "Allow for all future sessions" when setting is false (default)', async () => {
            ...
            const { lastFrame, waitUntilReady, unmount } = renderWithProviders(_jsx(ToolConfirmationMessage, { callId: "test-call-id", confirmationDetails: editConfirmationDetails, config: mockConfig, getPreferredEditor: vi.fn(), availableTerminalHeight: 30, terminalWidth: 80 }), {
