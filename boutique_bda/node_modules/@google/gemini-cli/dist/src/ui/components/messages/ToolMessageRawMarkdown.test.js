...
describe('<ToolMessage /> - Raw Markdown Display Snapshots', () => {
    ...
    ])('renders with renderMarkdown=$renderMarkdown, useAlternateBuffer=$useAlternateBuffer $description', async ({ renderMarkdown, useAlternateBuffer, availableTerminalHeight }) => {
        const { lastFrame, waitUntilReady, unmount } = renderWithProviders(_jsx(StreamingContext.Provider, { value: StreamingState.Idle, children: _jsx(ToolMessage, { ...baseProps, availableTerminalHeight: availableTerminalHeight }) }), {
