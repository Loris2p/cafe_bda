...
describe('TableRenderer', () => {
    it('renders a 3x3 table correctly', async () => {
        ...
        const renderResult = renderWithProviders(_jsx(TableRenderer, { headers: headers, rows: rows, terminalWidth: terminalWidth }));
    ...
    it('renders a complex table with mixed content lengths correctly', async () => {
        ...
        const renderResult = renderWithProviders(_jsx(TableRenderer, { headers: headers, rows: rows, terminalWidth: terminalWidth }), { width: terminalWidth });
        const { lastFrame, waitUntilReady, unmount } = renderResult;
        await waitUntilReady();
        const output = lastFrame();
