...
describe('PrivacyNotice', () => {
    ...
    ])('renders $expectedComponent when authType is $authType', async ({ authType, expectedComponent }) => {
        vi.mocked(mockConfig.getContentGeneratorConfig).mockReturnValue({
            authType,
        });
        const { lastFrame, waitUntilReady, unmount } = render(_jsx(PrivacyNotice, { config: mockConfig, onExit: onExit }));
