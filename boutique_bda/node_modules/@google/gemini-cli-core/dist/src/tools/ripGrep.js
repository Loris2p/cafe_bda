...
class GrepToolInvocation extends BaseToolInvocation {
    ...
    async performRipgrepSearch(options) {
        const { pattern, path, basePath, include_pattern, exclude_pattern, case_sensitive, fixed_strings, context, after, before, no_ignore, maxMatches, max_matches_per_file, } = options;
