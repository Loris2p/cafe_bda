...
export class GetInternalDocsTool extends BaseDeclarativeTool {
    ...
    constructor(messageBus) {
        super(GetInternalDocsTool.Name, 'GetInternalDocs', GET_INTERNAL_DOCS_DEFINITION.base.description, Kind.Think, GET_INTERNAL_DOCS_DEFINITION.base.parametersJsonSchema, messageBus, 
