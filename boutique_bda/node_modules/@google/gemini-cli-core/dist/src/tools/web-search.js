...
export class WebSearchTool extends BaseDeclarativeTool {
    ...
    constructor(config, messageBus) {
        super(WebSearchTool.Name, 'GoogleSearch', WEB_SEARCH_DEFINITION.base.description, Kind.Search, WEB_SEARCH_DEFINITION.base.parametersJsonSchema, messageBus, true, // isOutputMarkdown
        false);
        this.config = config;
    }
    /**
