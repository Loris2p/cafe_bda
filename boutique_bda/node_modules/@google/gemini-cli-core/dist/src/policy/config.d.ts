...
import { type PolicyEngineConfig, type PolicyRule, ApprovalMode, type PolicySettings, type SafetyCheckerRule } from './types.js';
 ...
 */
export declare function loadExtensionPolicies(extensionName: string, policyDir: string): Promise<{
    rules: PolicyRule[];
