...
describe('PolicyEngine', () => {
    ...
    describe('removeRulesForTool', () => {
        ...
        it('should remove rules for specific tool and source', () => {
            ...
            expect(rules.some((r) => r.toolName === 'tool1' && r.source === 'source2')).toBe(true);
            expect(rules.some((r) => r.toolName === 'tool2' && r.source === 'source1')).toBe(true);
            expect(rules.some((r) => r.toolName === 'tool1' && r.source === 'source1')).toBe(false);
        });
