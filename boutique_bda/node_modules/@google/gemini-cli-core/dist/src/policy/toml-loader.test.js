...
`);
        ...
        it('should support modes property for Tier 4 and Tier 5 policies', async () => {
            await fs.writeFile(path.join(tempDir, 'tier4.toml'), `
[[rule]]
toolName = "tier4-tool"
decision = "allow"
priority = 100
modes = ["autoEdit"]
`);
            const getPolicyTier4 = (_dir) => 4; // Tier 4 (User)
