...
describe('Storage – additional helpers', () => {
    ...
    describe('Session and JSON Loading', () => {
        ...
        it('loadProjectTempFile loads and parses JSON from relative path', async () => {
            ...
            const result = await storage.loadProjectTempFile('some/file.json');
            expect(readFileSpy).toHaveBeenCalledWith(expect.stringContaining(path.join(PROJECT_SLUG, 'some/file.json')), 'utf8');
    ...
    describe('getPlansDir', () => {
        const testCases = [
            ...
            },
            {
                ...
                expected: '',
                expectedError: "Custom plans directory '/absolute/path/to/plans' resolves to '/absolute/path/to/plans', which is outside the project root '/tmp/project'.",
            },
            {
            ...
            },
            {
                ...
                expected: '',
                expectedError: "Custom plans directory '../escaped-plans' resolves to '/tmp/escaped-plans', which is outside the project root '/tmp/project'.",
            },
            {
            ...
            },
            {
                ...
                expected: '',
                expectedError: "Custom plans directory 'symlink-to-outside' resolves to '/outside/project/root', which is outside the project root '/tmp/project'.",
            },
        ];
            ...
            it(`should handle ${name}`, async () => {
                ...
                try {
                    ...
                    if (expectedError) {
                        ...
                        const expectedValue = typeof expected === 'function' ? expected() : expected;
