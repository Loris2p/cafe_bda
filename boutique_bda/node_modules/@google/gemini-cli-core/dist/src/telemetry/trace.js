...
import { GEN_AI_AGENT_DESCRIPTION, GEN_AI_AGENT_NAME, GEN_AI_CONVERSATION_ID, GEN_AI_INPUT_MESSAGES, GEN_AI_OPERATION_NAME, GEN_AI_OUTPUT_MESSAGES, SERVICE_DESCRIPTION, SERVICE_NAME, } from './constants.js';
        ...
        const endSpan = () => {
            try {
                if (meta.input !== undefined) {
                    span.setAttribute(GEN_AI_INPUT_MESSAGES, safeJsonStringify(meta.input));
                }
                if (meta.output !== undefined) {
                    span.setAttribute(GEN_AI_OUTPUT_MESSAGES, safeJsonStringify(meta.output));
                }
