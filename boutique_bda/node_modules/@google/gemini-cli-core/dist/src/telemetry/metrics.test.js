...
describe('Telemetry Metrics', () => {
    ...
    describe('recordModelRoutingMetrics', () => {
        ...
        it('should record latency for a successful routing decision', () => {
            initializeMetricsModule(mockConfig);
            const event = new ModelRoutingEvent('gemini-pro', 'default', 150, 'test-reason', false, undefined, ApprovalMode.DEFAULT);
            recordModelRoutingMetricsModule(mockConfig, event);
        ...
        it('should record latency and failure for a failed routing decision', () => {
            initializeMetricsModule(mockConfig);
            const event = new ModelRoutingEvent('gemini-pro', 'Classifier', 200, 'test-reason', true, 'test-error', ApprovalMode.DEFAULT);
            recordModelRoutingMetricsModule(mockConfig, event);
