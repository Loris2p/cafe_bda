 ...
 */
export declare function recordOverageOptionSelected(config: Config, attributes: MetricDefinitions[typeof OVERAGE_OPTION_COUNT]['attributes']): void;
/**
 * Records a metric for a credit purchase link click.
 */
export declare function recordCreditPurchaseClick(config: Config, attributes: MetricDefinitions[typeof CREDIT_PURCHASE_COUNT]['attributes']): void;
export {};
