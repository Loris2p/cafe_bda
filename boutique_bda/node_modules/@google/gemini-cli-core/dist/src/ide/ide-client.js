...
import { getConnectionConfigFromFile, getIdeServerHost, getPortFromEnv, getStdioConfigFromEnv, validateWorkspacePath, createProxyAwareFetch, } from './ide-connection-utils.js';
const logger = {
...
export class IdeClient {
    ...
    async connect(options = {}) {
        ...
        const workspacePath = connectionConfig?.workspacePath ??
