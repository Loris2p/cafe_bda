...
import { DEFAULT_GEMINI_FLASH_LITE_MODEL, DEFAULT_GEMINI_MODEL, PREVIEW_GEMINI_MODEL_AUTO, isAutoModel, isGemini3Model, resolveModel, } from '../config/models.js';
/**
...
export function resolvePolicyChain(config, preferredModel, wrapsAround = false) {
    ...
    const useCustomToolModel = useGemini31 &&
    ...
    if (resolvedModel === DEFAULT_GEMINI_FLASH_LITE_MODEL) {
        ...
        if (hasAccessToPreview) {
            const previewEnabled = isGemini3Model(resolvedModel) ||
