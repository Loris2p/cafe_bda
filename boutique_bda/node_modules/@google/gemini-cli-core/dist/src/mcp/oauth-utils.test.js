...
describe('OAuthUtils', () => {
    ...
    describe('buildWellKnownUrls', () => {
        ...
        it('should handle deep paths per RFC 9728', () => {
            const urls = OAuthUtils.buildWellKnownUrls('https://app.mintmcp.com/s/g_2lj2CNDoJdf3xnbFeeF6vx/mcp');
            expect(urls.protectedResource).toBe('https://app.mintmcp.com/.well-known/oauth-protected-resource/s/g_2lj2CNDoJdf3xnbFeeF6vx/mcp');
            expect(urls.authorizationServer).toBe('https://app.mintmcp.com/.well-known/oauth-authorization-server/s/g_2lj2CNDoJdf3xnbFeeF6vx/mcp');
        });
    });
    ...
    describe('discoverOAuthConfig', () => {
        ...
        it('should throw error when resource metadata does not match server URL', async () => {
            ...
            await expect(OAuthUtils.discoverOAuthConfig('https://example.com/mcp')).rejects.toThrow(/does not match expected/);
        });
    });
